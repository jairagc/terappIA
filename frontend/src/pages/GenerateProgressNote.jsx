...
export default function GenerateProgressNote() {
  ...
  // Cargar pacientes del doctor en su org
  useEffect(() => {
    let alive = true;
  ...
  const rightActions = (
    <div className="header-actions">
      ...
      <button onClick={handleLogout} className="btn h-10" data-variant="ghost">
        Cerrar sesión
      </button>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="page-note">
        {/* Título + chips + tarjeta doctor */}
        <div className="flex flex-col-reverse lg:flex-row gap-5 lg:items-end lg:justify-between mb-6">
          <div>
            <h1 className="h1" style={{ fontSize: 32, margin: 0 }}>
              Seleccionar paciente
            </h1>
            <div className="kpi-row">
              <span className="kpi brand">
        ...
        {/* Selector + CTA registro */}
        <div className="form-row">
          <div style={{ flex: "1 1 520px", maxWidth: 620, marginTop: 20}}>
        ...
        {/* Accesos a modales: dos tarjetas medianas */}
        <div className="cards-2">
          ...
          >
            ...
            <div>
              ...
              <p className="caption text-muted" style={{ marginTop: 4 }}>
                Toma una foto o elige de tu galería. Extraemos texto con OCR.
              </p>
            </div>
          </button>
